-- Migration: Make user_id optional in RPC functions
-- This allows non-user-scoped extractors (feedback, agent_success) to get interactions across all users
...
-- Recreate get_last_k_interactions with optional user_id filtering
...
-- Recreate get_new_request_interaction_groups with optional user_id filtering
