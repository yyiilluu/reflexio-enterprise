-- Migration: Change source filter from single text to text array
-- This enables filtering interactions by multiple sources at once

-- Drop existing function to update signature (changing p_source to p_sources array)
...
CREATE OR REPLACE FUNCTION public.get_last_k_interactions(
    ...
    p_sources text[] DEFAULT NULL,  -- Changed from text to text[] for multiple sources
