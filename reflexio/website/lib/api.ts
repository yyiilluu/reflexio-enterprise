...
export async function getRawFeedbacks(
	request: GetRawFeedbacksRequest,
): Promise<GetRawFeedbacksResponse> {
	try {
...
export async function upgradeAllProfiles(
	onlyAffectedUsers: boolean = false,
): Promise<UpgradeProfilesResponse> {
	try {
...
export async function downgradeAllProfiles(
	onlyAffectedUsers: boolean = false,
): Promise<DowngradeProfilesResponse> {
	try {
...
export async function deleteRawFeedback(
	request: DeleteRawFeedbackRequest,
): Promise<DeleteRawFeedbackResponse> {
	try {
