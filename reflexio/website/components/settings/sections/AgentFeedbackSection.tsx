...
import type { AgentFeedbackConfig, Config } from "@/app/settings/types";
			...
			<Card className="border-slate-200 bg-white overflow-hidden hover:shadow-lg transition-all duration-300">
				...
				<CardContent>
									...
									>
										...
										<Button
											...
											onClick={(e) => {
												...
												setDeleteTarget({
													id: feedback.id,
													name: feedback.feedback_name || "Unnamed feedback",
												});
											}}
									...
									<AccordionContent className="pt-2 pb-5 space-y-4">
										...
										<div>
											...
											<textarea
												...
												onChange={(e) =>
													onUpdate(feedback.id, {
														feedback_definition_prompt: e.target.value,
													})
												}
										...
										<div className="grid gap-4 sm:grid-cols-2">
											...
											<div>
												...
												/>
												<p className="text-xs text-muted-foreground mt-1">
													New feedbacks to trigger feedback aggregation
												</p>
											</div>
										</div>
					...
					<Button
						onClick={onAdd}
						variant="outline"
						className={`w-full h-9 text-sm ${feedbacks.length > 0 ? "mt-4" : ""}`}
					>
