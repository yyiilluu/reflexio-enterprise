				...
				<div className="flex items-center gap-3">
					...
					<div>
						...
						<CardDescription className="text-xs mt-1 text-muted-foreground">
							Configure extraction window settings
						</CardDescription>
					</div>
				</div>
			</CardHeader>
			<CardContent>
				<div className="grid gap-4 sm:grid-cols-2">
					<div>
						<FieldLabel
							htmlFor="window-size"
							tooltip="Number of interactions analyzed per extraction batch"
						>
							Window Size
						</FieldLabel>
						<Input
					...
					<div>
						<FieldLabel
							htmlFor="window-stride"
							tooltip="Number of interactions to skip between extraction batches"
						>
							Window Stride
						</FieldLabel>
						<Input
