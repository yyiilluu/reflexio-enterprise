...
import { Key, ChevronDown, ChevronUp, Circle, Globe, Cpu, Bot, Router, Sparkles, Layers } from "lucide-react"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription className="text-xs mt-1 text-muted-foreground">API keys and provider configuration</CardDescription>
            </div>
          </div>
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                <div>
                  ...
                  <Input
                    ...
                    className="h-10"
                  />
                  <p className="text-xs text-muted-foreground mt-1">Model identifier passed to LiteLLM</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">Authentication key for the endpoint</p>
                </div>
              </div>
            </div>
          )}
              ...
              {openaiMode === "direct" ? (
                <div>
                  ...
                  <PasswordInput
                    ...
                    placeholder="sk-..."
                  />
                  <p className="text-xs text-muted-foreground mt-2">Your OpenAI API key for direct API access</p>
                </div>
              ) : (
            ...
            <div className="p-5 border border-slate-200 rounded-lg space-y-4 bg-slate-50">
              ...
              <div>
                ...
                <PasswordInput
                  ...
                  placeholder="sk-ant-..."
                />
                <p className="text-xs text-muted-foreground mt-2">Your Anthropic API key for Claude models</p>
              </div>
            </div>
          )}
            ...
            <div className="p-5 border border-slate-200 rounded-lg space-y-4 bg-slate-50">
              ...
              <div>
                ...
                <PasswordInput
                  ...
                  placeholder="sk-or-..."
                />
                <p className="text-xs text-muted-foreground mt-2">Your OpenRouter API key for accessing multiple providers</p>
              </div>
            </div>
          )}
            ...
            <div className="p-5 border border-slate-200 rounded-lg space-y-4 bg-slate-50">
              ...
              <div>
                ...
                <PasswordInput
                  ...
                  placeholder="eyJ..."
                />
                <p className="text-xs text-muted-foreground mt-2">Your MiniMax API key. Use model prefix &quot;minimax/&quot; (e.g., minimax/MiniMax-Text-01)</p>
              </div>
            </div>
          )}
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div>
                ...
                <Input
                  ...
                  className="h-10"
                />
                <p className="text-xs text-muted-foreground mt-1">Model for generation & evaluation</p>
              </div>
              <div>
